...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <h1><a href="index.html">UTE <span>Admin</span></a></h1>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li><a href="{{route('admin.index.getUserList')}}"><i class="lnr lnr-user"></i> <span>Tài khoản</span></a></li>

...
<body >
			...
			<div class="header-right" style="background-color: #0277b8;">
					...
					<nav class="main-menu">
						<ul class="l-inline ov">
							...
							<li><a href="{{route('uploadProduct')}}">Đăng bán món đồ</a></li>	
		...
		<div class="shopping-cart">
			...
			<div id="myDropdown" class="dropdown-content">
				<ul style="list-style: none;">
					...
					?>
					<li class="dropli"><a href="{{route('notification.getNotification',$note->id)}}">Bạn có một yêu cầu mới từ <span style="color: black">{{$user->name}}</span></a></li>
					...
					<div class="widget">
						...
						<div>
							<ul>
								...
								<li><a href="blog_fullwidth_2col.html"><i class="fa fa-chevron-right"></i> Giới thiệu website đồ cũ UTE</a></li>
					...
					<div class="widget">
						...
						<div>
							<div class="contact-info">
								...
								<p>Số điện thoại: 243423324234 </p>
							</div>
						</div>
					</div>
				  </div>
	...
	<!-- <div class="copyright">
		<div class="container">
			<p class="pull-left">Copyright information (&copy;) 2021</p>

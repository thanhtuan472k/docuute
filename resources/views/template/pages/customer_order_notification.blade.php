			...
			<div class="col-sm-9">
				...
				<div class="space20">&nbsp;</div>
					...
					<table class="table" 
						...
						<p>Tên Sinh Viên: {{$n_customer->name}}</p>
					...
					<div class="row">
						...
						@if ($n_note->isDone==1)
							<p class="col-md-3">Tình trạng: Giao dịch thành công</p>
						@else
							<a class="btn btn-primary col-md-3" href="{{route('notification.getComfirm',$n_note->id)}}" onclick="return confirm('Xác nhận giao dịch thành công ?')">Xác nhận giao dịch</a>
						@endif
